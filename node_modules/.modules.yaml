...
hoistedDependencies:
  ...
  jest-circus@30.0.5:
    jest-circus: private
  jest-cli@30.0.5(@types/node@22.15.17):
    jest-cli: private
  jest-config@30.0.5(@types/node@22.15.17):
    jest-config: private
  jest-diff@30.0.5:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Tue, 26 Aug 2025 19:06:20 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@unrs/resolver-binding-win32-x64-msvc@1.11.1'
  - tslib@2.8.1
storeDir: /Users/jesus/Library/pnpm/store/v3
